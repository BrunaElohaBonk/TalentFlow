                        ...
                        {filtro.length === 0 ? (<p className="turma-vazia">Nenhuma turma encontrada.</p>) : (
                            filtro.map((item) => (
                                <div className="turma-item" key={item.id}>
                                    <span className="turma-titulo" title={item.nomeTurma}>{item.nomeTurma}</span>
                                    <div className="turma-acoes">
                                        ...
                                        <button type="button" className="btn-acao"onClick={() => handleDelete(item.id)}><img src={lixeira} alt="Excluir"/></button>
                                    </div>
                                </div>
                            ))
                        )}
